...
ActiveRecord::Schema.define(version: 2018_08_29_172738) do
  ...
  create_table "spree_page_translations", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
